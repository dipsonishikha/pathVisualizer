import type { MazeSelectType, SpeedSelectType ,AlgorithmSlectType} from "./types";
...
"lg:w-[17px] md:w-[10px] xs:w-[8px] w-[7px] lg:h-[17px] md:h-[15px] xs:h-[8px] h-[7px] border-t border-r border-sky-200";
...
export const PATH_TILE_STYLE=TILE_STYLE+"bg-yellow-400"
...
export const PATHFINDING_ALGORITHMS:AlgorithmSlectType[]=[
